...
\begin{itemize}
	\item $H0: \theta = 0.5, $ and $ H1: \theta > 0.5$. This is a \textbf{one-sided} alternative.
	\item $H0: \theta = 0.5, $ and $ H1: \theta < 0.5$. This is \textbf{another one-sided} alternative.
	\item $H0: \theta = 0.5, $ and $ H1: \theta ̸\neq 0.5$. This is a \textbf{two-sided} alternative.
\end{itemize}
\end{commentbox}
